...
### 3. 📩 Spam Email Classifier (NLP/LSTM)
...
* **NLP Tools:** NLTK, WordCloud, TextVectorization, Word Embeddings.
* **Data Science:** Pandas, NumPy, Scikit-Learn.
* **Visualization:** Matplotlib, Seaborn.
* **Architectures:** Dense Networks, LSTMs, Bidirectional LSTMs, Transfer Learning.
